...
class ListFragment : Fragment() {
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        if(item.itemId === 1){
            ...
            val myPlacesList: ListView = requireView().findViewById<ListView>(R.id.my_places_list)
            myPlacesList.adapter = this@ListFragment.context?.let { ArrayAdapter<MyPlace>(it, android.R.layout.simple_expandable_list_item_1, myPlacesViewModel.myPlacesList) }
